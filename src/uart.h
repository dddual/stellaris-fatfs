 ...
 * \date   2013
 ****************************************************************************/
/* This file is part of stellaris-fatfs source package.
 *
 * stellaris-fatfs is free software: you can redistribute
 ...
 * along with stellaris-fatfs.  If not, see <http://www.gnu.org/licenses/>.
 */
